...
CREATE TABLE 'Drug_Interaction' (
	'Drug_Interaction_ID' INT(100000) NOT NULL,
	'Drug_1_Name' varchar(50),
	'Drug_1_RxCUI' varchar(50),
	'Drug_1_Class_Name' varchar(100),
	'Drug_1_Code' varchar(50),
	'Drug_2_Name' varchar(50),
	'Drug_2_RxCUI' varchar(50),
	'Drug_2_Class_Name' varchar(100),
...
LOAD DATA LOCAL INFILE './eng_groups_tables_2015_xml_v3_v5_atc_codes.tsv' INTO TABLE
'ATC_Code' FIELDS TERMINATED BY '\t' LINES TERMINATED BY '\n' ('ATC_Code', 'Drug_Name');

LOAD DATA LOCAL INFILE './eng_groups2015_xml_v3.tsv' INTO TABLE
'Drug_Group' FIELDS TERMINATED BY '\t' LINES TERMINATED BY '\n' ('Drug_Name', 'RxNorm', 'Source_File', 'Clinical_Source', 'Class_Name', 'Class_Code');

LOAD DATA LOCAL INFILE './eng_tables2015-xml-v5.tsv' INTO TABLE
'Drug_Interaction' FIELDS TERMINATED BY '\t' LINES TERMINATED BY '\n' ('Drug_Interaction_ID', 'Drug_1_Name', 'Drug_1_RxCUI', 'Drug_1_Class_Name', 'Drug_1_Code', 'Drug_2_Name', 'Drug_2_RxCUI', 'Drug_2_Class_Name', 'Drug_2_Code', 'Clinical_Source', 'Source_File', 'Description', 'Severity', 'Comment');
